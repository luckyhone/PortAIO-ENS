namespace SharpShooter.MyPlugin
{
    ...
    public class Varus : MyLogic
    {
        ...
        private static void Initializer()
        {
            ...
            Q.SetSkillshot(0.25f, 70f, 1650f, false,SpellType.Line );
            Q.SetCharged("VarusQ", "VarusQ", 925, 1600, 1.5f);

            W = new Spell(SpellSlot.W, 0f);

            E = new Spell(SpellSlot.E, 975f);
            E.SetSkillshot(0.35f, 120f, 1500f, false,SpellType.Circle );

            R = new Spell(SpellSlot.R, 1050f);
            R.SetSkillshot(0.25f, 120f, 1950f, false,SpellType.Line );
        ...
        {
            var dmg = GetBuffCount(target) * Me.GetSpellDamage(target, SpellSlot.W);
