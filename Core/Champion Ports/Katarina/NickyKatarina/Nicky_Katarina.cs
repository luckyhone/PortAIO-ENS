...
namespace Nicky_Katarina
{
    ...
    internal class Katarina
    {
        ...
        private static void Combat()
        {
            ...
            if (E.IsReady() && target.IsValidTarget(E.Range) && ComboKat.E.Enabled)
            {
                if (target != null)
                {
                    var dagger = ObjectManager.Get<AIBaseClient>().Where(a => a.Name == "HiddenMinion" && a.IsValid && !a.IsDead);
            ...
            if (W.IsReady() && target.IsValidTarget(W.Range) && ComboKat.W.Enabled)
            {
                if (target != null)
                {
                    W.Cast();
            ...
            if (Q.IsReady() && target.IsValidTarget(Q.Range) && ComboKat.Q.Enabled)
            {
                if (target != null)
                {
                    Q.CastOnUnit(target);
            ...
            if (R.IsReady() && target.IsValidTarget(R.Range - 50) && ComboKat.R.Enabled)
            {
            ...
            if (R.IsReady() && target.IsValidTarget(R.Range - 150) && ComboKat.R.Enabled)
            {
