...
namespace Easy_Sup.scripts
{
    class Blitz
    {
        ...
        public static void BlitzOnLoad()
        {
            ...
            _q.SetSkillshot(0.25f, 70f, 1800f, true, SpellType.Line);
        ...
        private static void Combo()
        {
            ...
            if (useq && _q.IsReady())
            {
                var qtarget = TargetSelector.GetTarget(_q.Range,_q.DamageType);
                if (qtarget == null)
                    return;
            ...
            if (usee && _e.IsReady())
            {
                var etarget = TargetSelector.GetTarget(350,DamageType.Mixed);
