...
namespace EzAIO.Champions.Jhin
{
    sealed class Jhin : ChampionBases
    {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            {
                DrawCircle(GameObjects.Player.Position,Q.Range,Color.Cyan.ToSharpDxColor());
            }
            if (DrawMenu.WBool.Enabled)
            {
                DrawCircle(GameObjects.Player.Position,W.Range,Color.Cyan.ToSharpDxColor());
            }
            if (DrawMenu.EBool.Enabled)
            {
                DrawCircle(GameObjects.Player.Position,E.Range,Color.Cyan.ToSharpDxColor());
            }
            if (DrawMenu.RBool.Enabled)
            {
                DrawCircle(GameObjects.Player.Position,RShot.Range,Color.Cyan.ToSharpDxColor());
            }
