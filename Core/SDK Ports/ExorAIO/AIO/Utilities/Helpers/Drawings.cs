...
namespace ExorAIO.Utilities
{
    ...
    internal class Drawings
    {
            ...
            Drawing.OnDraw += delegate
                {
                    ...
                    {
                        if (Vars.Menu["drawings"]["r"] != null && Vars.Menu["drawings"]["r"].GetValue<MenuBool>().Enabled)
                        {
                            if (globalChampions.Contains(GameObjects.Player.CharacterName))
                            {
        ...
        {
            return SpecialChampions.Contains(target.CharacterName) ? 1 : 10;
        }
        ...
        {
            return SpecialChampions.Contains(target.CharacterName) ? 3 : 20;
        }
